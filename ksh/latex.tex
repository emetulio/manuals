...
\begin{center}
     \Large{\textbf{Korn Shell Programming}}
\end{center}

\section{Wildcards}
\begin{tabular}{@{}ll@{}}
\verb!?!    & Default is two-sided. \\
\verb!*!  & No \verb!\part! divisions. \\
\verb![set]! & No \verb!\part! or \verb!\chapter! divisions. \\
\verb![!set]!  & Letter (?). \\
\verb![a-z]!  & Large sans-serif font.
\end{tabular}
